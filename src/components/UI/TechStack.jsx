        ...
        <div className="flex flex-col gap-2 w-32">
          {techItems.map((tech, index) => (
            <div
              ...
              className="group relative h-14 overflow-hidden cursor-pointer rounded-lg transition-all duration-500 bg-gray-100 flex items-center justify-center hover:h-20 hover:shadow-md border-2 border-transparent"
              style={{
            ...
            >
              <img
                src={tech.icon}
                alt={tech.name}
                className="w-10 h-10 object-contain transition-all duration-300 group-hover:w-12 group-hover:h-12"
              />
